...
export const ABOUT_SECTION_HEADLINE: TextSegment[] = [
    ...
    },
    {
        ...
        isHighlighted: true,
        className:
            'text-blue-600 border-2 border-blue-500 inline-block xl:h-16 border-dotted px-2 rounded-md',
    },
    {
    ...
    },
    {
        ...
        isHighlighted: true,
        className:
            'text-orange-600 border-2 border-orange-500 inline-block xl:h-16 border-dotted px-2 rounded-md',
    },
    {
    ...
    },
    {
        ...
        isHighlighted: true,
        className:
            'text-green-600 border-2 border-green-500 inline-block xl:h-16 border-dotted px-2 rounded-md',
    },
];
