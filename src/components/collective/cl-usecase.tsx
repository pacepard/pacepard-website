                    ...
                    <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card className="overflow-hidden p-6">
                            ...
                            <p className="text-muted-foreground mt-3 text-balance">
                                Our advanced AI models transform natural
                                language into production-ready code.
                            </p>
                        ...
                        <Card className="group overflow-hidden px-6 pt-6">
                            ...
                            <p className="text-muted-foreground mt-3 text-balance">
                                Our AI analyzes your code for bugs, security
                        ...
                        <Card className="group overflow-hidden px-6 pt-6">
                            ...
                            <p className="text-muted-foreground mt-3 text-balance">
                                A personalized AI companion that understands
                                your codebase and helps solve complex...
                            </p>
        ...
        >
            <div className="w-fit">
                ...
                <p className="mt-2 line-clamp-2 text-sm">
                    How can I optimize my neural network to reduce inference
